...
struct Recipes {
    ...
    static func getRecipe()->[Recipes] {
        return [
            ...
            Recipes(recipeName: "Спагетти", recipeAuthor: "С.Петров", recipeRating: 0.3, recipeText: "Cпагетти - 250 г,Куриные бедра - 2 шт., Помидоры измельченные или томатный сок - 200 мл, Чеснок - 1 зубчик, Лук репчатый - 1 шт., Сыр твёрдый - 30 г", recipeIcon: "ic_spagetti", recipeImage: "im_spagetti"),
            ...
            Recipes(recipeName: "Мол. коктейл", recipeAuthor: "В.Лось", recipeRating: 4.5, recipeText: "Банан 2, Молоко или кокосовое молоко 350 мл. Какао 2 ст. ложки, Мед 1 ст, ложка, Кокосовая стружка для присыпки", recipeIcon: "ic_milkshake", recipeImage: "im _milkshake"),
                        
            Recipes(recipeName: "Блинчики", recipeAuthor: "Л.Усова", recipeRating: 3.3, recipeText: "Яйцо -  шт., Мука - 150 г., Молоко - 150 мл., Подсолнечное масло - 15 мл., Соль (по вкусу) - 20 г., Сахар (по вкусу) - 20 г.,", recipeIcon: "ic_blin", recipeImage: "im_blin")
        ]
    }
}
